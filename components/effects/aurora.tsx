  ...
  return (
    ...
    >
      <div
        ...
        style={{ background: "radial-gradient(circle, rgb(44 70 230 / 0.55), transparent 60%)", filter: "blur(55px)" }}
      />
      <div
        className="aurora-blob absolute right-[16%] top-[16%] h-[280px] w-[280px] rounded-full opacity-45 sm:h-[420px] sm:w-[420px]"
        style={{ background: "radial-gradient(circle, rgb(168 85 247 / 0.5), transparent 60%)", filter: "blur(55px)", animationDelay: "-7s", animationDuration: "26s" }}
      />
      <div
        ...
        style={{ background: "radial-gradient(circle, rgb(34 211 238 / 0.42), transparent 60%)", filter: "blur(58px)", animationDelay: "-14s", animationDuration: "30s" }}
      />
    </div>
  );
}
